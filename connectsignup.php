...
$sql = "INSERT INTO registration (firstname,lastname,email,password,confirmpassword)
        ...
        <form action="connectsignup.php" method="POST">
          <table>
            ...
            <tr>
              <td colspan="3">
                <div>
                  <input placeholder="First Name" type="text" name="firstname"/> <span><input placeholder="Last Name"
                      style="float: right;" type="text" name="lastname"/></span>
                </div>
              </td>
            </tr>
            <tr>
